...
RETURN
GO
PRINT N'Creating [dbo].[UpdateUserRole]...';
...
AS
	...
	Product.[CartDescription],Product.[ShortDescription],Product.[Image],Product.[MRP],
	Product.[DealPrice],Product.[SavePrice],Product.[NoOfStock],WishList.[DateOfCartAdd]
